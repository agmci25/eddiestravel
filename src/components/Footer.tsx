      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-background/70">
            ...
            <li><Link to="/golf-tours" className="hover:text-primary transition-colors">Golf Tours</Link></li>
            <li><Link to="/shore-excursions" className="hover:text-primary transition-colors">Shore Excursions</Link></li>
